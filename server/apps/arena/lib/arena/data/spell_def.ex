defmodule Arena.Data.SpellDef do
  ...
  def from_section(id, section) do
    %__MODULE__{
      ...
      ciega: parse_bool(section["ciega"]),
      cura_ceguera: parse_bool(section["removerceguera"]),
      estupidez: parse_bool(section["estupidez"]),
      cura_estupidez: parse_bool(section["removerestupidez"]),
