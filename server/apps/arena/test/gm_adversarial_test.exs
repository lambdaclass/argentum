defmodule Arena.GmAdversarialTest do
  ...
  describe "GM slash commands work for authorized GMs at map level" do
    ...
    test "unknown GM slash command returns 'Unknown GM command'" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/NOSUCHCMD")
  ...
  describe "Batch 5 - Map & Environment: GM /ASKTRIGGER reads trigger" do
    test "reads trigger at facing tile" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/ASKTRIGGER")
  ...
  describe "Batch 4 - Communication: GM /RMSG sends faction message" do
    test "returns {:noreply, state} and GM receives confirmation" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/RMSG Attention troops!")
  ...
  describe "Batch 4 - Communication: GM /CMSG sends chaos faction message" do
    test "returns {:noreply, state} and GM receives confirmation" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/CMSG Dark legion orders!")
      assert_receive {:send_raw, _raw}
    end
  end
  ...
  describe "Batch 4 - Punishment: GM /REMOVEPUNISHMENT" do
    test "returns {:noreply, state} and sends confirmation" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/REMOVEPUNISHMENT Victim 1 reason")
      assert_receive {:send_raw, _raw}
    end
  end
  ...
  describe "Batch 6 - Audio: GM /FORCEMIDIMAP sends MIDI to map" do
    test "sends MIDI packet to sessions" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/FORCEMIDIMAP 5 1")
  ...
  describe "Batch 6 - Audio: GM /FORCEWAVEMAP sends wave to map" do
    test "sends wave packet to sessions" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/FORCEWAVEMAP 3 50 50 1")
      assert_receive {:send_raw, _raw}
    end
  end
  ...
  describe "Batch 6 - Utility: GM /ITEMSFLOOR counts floor items" do
    test "sends floor item count" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/ITEMSFLOOR")
      assert_receive {:send_raw, _raw}
    end
  end
  ...
  describe "edge cases: GM commands with invalid parameters" do
    ...
    test "/TELEPORT with non-numeric coordinates returns usage message" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/TELEPORT abc def ghi")
    ...
    test "/SPAWNITEM with non-numeric item_id returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/SPAWNITEM abc")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/SPAWNITEM with zero amount returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/SPAWNITEM 100 0")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/SPAWNITEM with negative amount returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/SPAWNITEM 100 -5")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/FORCEMIDIMAP with non-numeric midi returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/FORCEMIDIMAP abc def")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/CHECKSLOT with non-numeric slot returns error" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/CHECKSLOT Victim abc")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/BANTEMPORAL with non-numeric days returns error" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/BANTEMPORAL Victim abc reason")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/CREATURES with non-numeric map_id returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/CREATURES abc")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/GIVEITEM with bad amount returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/GIVEITEM Victim abc xyz")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/EDITCHAR with invalid option returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/EDITCHAR Victim 99 abc")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/BAN with non-numeric days returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/BAN Victim abc")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/MUTE with non-numeric minutes returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/MUTE Victim abc")
      assert_receive {:send_raw, _raw}
    end
  end
  ...
  describe "edge cases: GM commands targeting non-existent players" do
    ...
    test "/KILL targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/KILL GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/INFO targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/INFO GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/KICK targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/KICK GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/REVIVE targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/REVIVE GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/UNMUTE targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/UNMUTE GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/COUNCILKICK targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/COUNCILKICK GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/ROYALCOUNCIL targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/ROYALCOUNCIL GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/CHAOSCOUNCIL targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/CHAOSCOUNCIL GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/ROYALKICK targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/ROYALKICK GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/CHAOSKICK targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/CHAOSKICK GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/CHARSTATS targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/CHARSTATS GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/CHARGOLD targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/CHARGOLD GhostPlayer")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/ALTERNAME targeting non-existent player returns not found" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/ALTERNAME GhostPlayer NewName")
      assert_receive {:send_raw, _raw}
    end
  end
  ...
  describe "edge cases: boundary values" do
    test "/CHECKSLOT with slot 0 (below minimum) returns error" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/CHECKSLOT Victim 0")
    ...
    test "/CHECKSLOT with negative slot returns error" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/CHECKSLOT Victim -1")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/BAN with zero days returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/BAN Victim 0")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/BAN with negative days returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/BAN Victim -5")
      assert_receive {:send_raw, _raw}
    end
    ...
    test "/MUTE with zero minutes returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/MUTE Victim 0")
      assert_receive {:send_raw, _raw}
    end
  ...
  describe "GM invasion edge cases" do
    ...
    test "/INVASION with zero count returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/INVASION 1 5 0")
      assert_receive {:send_raw, _}
    end
    ...
    test "/INVASION with count > 200 returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/INVASION 1 5 201")
      assert_receive {:send_raw, _}
    end
    ...
    test "/INVASION with negative count returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/INVASION 1 5 -1")
      assert_receive {:send_raw, _}
    end
    ...
    test "/INVASION STOP with no active invasion returns error" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/INVASION STOP 9999")
      assert_receive {:send_raw, _}
    end
    ...
    test "/INVASION STOP with non-numeric map_id returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/INVASION STOP abc")
      assert_receive {:send_raw, _}
    end
  end
  ...
  describe "GM tournament edge cases" do
    test "/TOURNAMENT CANCEL with no active tournament returns error" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/TOURNAMENT CANCEL")
      assert_receive {:send_raw, _}
    end
    ...
    test "/TOURNAMENT STATUS with no active tournament returns message" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/TOURNAMENT STATUS")
      assert_receive {:send_raw, _}
    end
    ...
    test "/TOURNAMENT BEGIN with no active tournament returns error" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/TOURNAMENT BEGIN")
      assert_receive {:send_raw, _}
    end
  end
  ...
  describe "GM event edge cases" do
    test "/EVENT START with zero duration returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/EVENT START xp_bonus 0")
      assert_receive {:send_raw, _}
    end
    ...
    test "/EVENT START with negative duration returns usage" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/EVENT START xp_bonus -5")
      assert_receive {:send_raw, _}
    end
    ...
    test "/EVENT STOP with no active event returns error" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/EVENT STOP xp_bonus")
      assert_receive {:send_raw, _}
    end
    ...
    test "/EVENT LIST with no active events returns message" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/EVENT LIST")
      assert_receive {:send_raw, _}
    end
    ...
    test "/EVENT START with unknown type maps to :custom" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/EVENT START unknown_type 5")
      assert_receive {:send_raw, _}
  ...
  describe "GM unknown command fallback" do
    test "GM sending unknown slash command receives error message" do
      ...
      {:noreply, _new_state} = Chat.handle_chat(state, :gm_player, "/NONEXISTENTCOMMAND")
      assert_receive {:send_raw, _}
    end
  end
end
